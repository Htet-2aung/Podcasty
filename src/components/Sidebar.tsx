...
// FIXED: Added 'export default' to make this the default export of the file
export default function Sidebar() {
  ...
  return (
    ...
    >
      <div className="h-full w-full bg-surface/80 md:bg-surface/50 backdrop-blur-xl border-r border-border p-4 flex flex-col">
